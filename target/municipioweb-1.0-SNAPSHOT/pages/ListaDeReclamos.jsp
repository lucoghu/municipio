...
<html lang="es">
    ...
    <body>
        ...
        <table border="1px solid black">
            ...
            <c:forEach var="reclamo" items="${ListaR}" >
               <tbody>
                 <tr>
                     ...
                     <td class="fila">
                         <a id="editarPersona" href="<c:url value="ReclamoServlet">
                            <c:param name="accion" value="buscaridReclamo" />
                            <c:param name="idreclamo" value="${reclamo.idreclamo}"/>  </c:url>"
                            class="bot"> Editar</a>                                                   
                        <!--<button type="button" class="bot" title="Editar">Editar </button>  -->
                        
                        
                        <a id="eliminarPersona" href="<c:url value="ReclamoServlet">
